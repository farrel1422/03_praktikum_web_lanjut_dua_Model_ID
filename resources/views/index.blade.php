			...
			<div class="row tm-gallery">
				...
				<div id="tm-gallery-page-pizza" class="tm-gallery-page">
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{asset('img/'.$home->gambar)}}" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
								<h4 class="tm-gallery-title">{{$home->namamakanan}}</h4>
								<p class="tm-gallery-description">{{$home->deskripsimakanan}}</p>
								<p class="tm-gallery-price">{{$home->hargamakanan}}</p>
							</figcaption>
						</figure>
					</article>
					@endforeach
